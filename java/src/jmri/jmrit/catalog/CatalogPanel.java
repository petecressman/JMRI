...
public class CatalogPanel extends JPanel {
    ...
    protected void init(boolean treeDnD, boolean dragIcons) {
        ...
        //_dTree.setDropMode(DropMode.ON); // is set by treeDnD
...
//        PreviewDialog.setBackGround(_preview, _currentBackground);
    ...
    public static CatalogPanel makeDefaultCatalog() {
        ...
        return makeDefaultCatalog(true, true, true); // deactivate dragNdrop? (true, true, false)
    }
    ...
    public class IconDisplayPanel extends JPanel implements MouseListener{
        ...
        void setBorderAndIcon(NamedIcon icon) {
            ...
            try {
                ...
                image.setIcon(icon);
                image.getPopupUtility().setJustification(PositionablePopupUtil.CENTRE);
