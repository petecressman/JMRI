...
//        log.info("w: {}, x: {}, h: {}, y: {}", "" + newMaxX, "" + newX, "" + newMaxY, "" + newY);
    ...
    public void rotateSelection90() {
        ...
        for (Positionable positionable : _positionableSelection) {
            ...
            if (rotateFlag) {
                positionable.setDegrees(positionable.getDegrees() + 90);
        ...
        for (Positionable positionable : positionables) {
            ...
            if (positionable instanceof PositionableLabel) {
                try {
                    ...
                    positionableLabel.setDegrees(positionableLabel.getDegrees() + 90);
                ...
                if (findLayoutTracksHitPoint(dLoc)) {
                    ...
                    if (selectedObject != null) {
                        ...
                        if (selectedObject != null) {
                            ...
                            startDelta.setLocation(MathUtil.subtract(((Positionable) selectedObject).getLocation(), dLoc));
                        } else {
...
//}
    ...
    protected void setLink(@Nonnull LayoutTrack fromObject, HitPointType fromPointType,
        ...
        switch (fromPointType) {
            case POS_POINT: {
                if (toPointType == HitPointType.TRACK) {
    ...
    void addSensor() {
        ...
        l.setStateIcon("SensorStateActive", leToolBarPanel.sensorIconEditor.getIcon(0));
        l.setStateIcon("SensorStateInactive", leToolBarPanel.sensorIconEditor.getIcon(1));
        l.setStateIcon("BeanStateInconsistent", leToolBarPanel.sensorIconEditor.getIcon(2));
        l.setStateIcon("BeanStateUnknown", leToolBarPanel.sensorIconEditor.getIcon(3));
        l.setSensor(newName);
    ...
    void addSignalHead() {
        ...
        l.setStateIcon("SignalHeadStateRed", leToolBarPanel.signalIconEditor.getIcon(0));
        l.setStateIcon("SignalHeadStateFlashingRed", leToolBarPanel.signalIconEditor.getIcon(1));
        l.setStateIcon("SignalHeadStateYellow", leToolBarPanel.signalIconEditor.getIcon(2));
        l.setStateIcon("SignalHeadStateFlashingYellow", leToolBarPanel.signalIconEditor.getIcon(3));
        l.setStateIcon("SignalHeadStateGreen", leToolBarPanel.signalIconEditor.getIcon(4));
        l.setStateIcon("SignalHeadStateFlashingGreen", leToolBarPanel.signalIconEditor.getIcon(5));
        l.setStateIcon("SignalHeadStateDark", leToolBarPanel.signalIconEditor.getIcon(6));
        l.setStateIcon("SignalHeadStateHeld", leToolBarPanel.signalIconEditor.getIcon(7));
        l.setStateIcon("SignalHeadStateLunar", leToolBarPanel.signalIconEditor.getIcon(8));
        l.setStateIcon("SignalHeadStateFlashingLunar", leToolBarPanel.signalIconEditor.getIcon(9));
