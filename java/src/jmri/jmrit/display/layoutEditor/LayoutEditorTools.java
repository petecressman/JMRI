...
//make this button the default button (return or enter activates)
    ...
    Point northEastToSouthWest(Point2D p, PositionableIcon l, int oldWidth, int oldHeight, double angleDEG, boolean right, double fromPoint) {
        ...
        if (log.isDebugEnabled()) {
            ...
            log.debug("newWidth {} newHeight {}", l.getWidth(), l.getHeight());
    ...
    Point southEastToNorthWest(Point2D p, PositionableIcon l, int oldWidth, int oldHeight, double angleDEG, boolean right, double fromPoint) {
        ...
        if (right) {
            ...
            log.debug("ydist {}", Double.toString((bpo - ta) - (l.getHeight() - iconAdjOpp)));
...
//operational variables for Set Signals at slip tool
    ...
    public SignalHeadIcon getSignalHeadIcon(@Nonnull String signalName) {
        ...
        l.setStateIcon("SignalHeadStateRed", signalIconEditor.getIcon(0));
        l.setStateIcon("SignalHeadStateFlashingRed", signalIconEditor.getIcon(1));
        l.setStateIcon("SignalHeadStateYellow", signalIconEditor.getIcon(2));
        l.setStateIcon("SignalHeadStateFlashingYellow", signalIconEditor.getIcon(3));
        l.setStateIcon("SignalHeadStateGreen", signalIconEditor.getIcon(4));
        l.setStateIcon("SignalHeadStateFlashingGreen", signalIconEditor.getIcon(5));
        l.setStateIcon("SignalHeadStateDark", signalIconEditor.getIcon(6));
        l.setStateIcon("SignalHeadStateHeld", signalIconEditor.getIcon(7));
        l.setStateIcon("SignalHeadStateLunar", signalIconEditor.getIcon(8));
        l.setStateIcon("SignalHeadStateFlashingLunar", signalIconEditor.getIcon(9));
        l.setDegrees(90);
        return l;
    }
