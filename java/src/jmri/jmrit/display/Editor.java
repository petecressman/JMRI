...
//        l.setHorizontalTextPosition(SwingConstants.CENTER);
    ...
    protected void addToTarget(Positionable pos) {
        pos.invalidate();
        _targetPanel.remove(pos);
        _targetPanel.add(pos, Integer.valueOf(pos.getDisplayLevel()));
        _targetPanel.moveToFront(pos);
        pos.repaint();
 ...
 /*
    ...
    public class TextAttrDialog extends DisplayFrame {
        ...
        TextAttrDialog(Positionable p, Editor ed) {
            ...
            setContentPane(sp);
            InstanceManager.getDefault(jmri.util.PlaceWindow.class).nextTo(_pos.getEditor(), _pos, this);
            pack();
        }
